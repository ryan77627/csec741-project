...
#define ECHO_TEST_RTS (UART_PIN_NO_CHANGE) //Remove me?
#define ECHO_TEST_CTS (UART_PIN_NO_CHANGE) //Remove me?

#define ECHO_UART_PORT_NUM (CONFIG_EXAMPLE_UART_PORT_NUM)
#define ECHO_UART_BAUD_RATE (CONFIG_EXAMPLE_UART_BAUD_RATE)
#define ECHO_UART_STACK_SIZE (CONFIG_EXAMPLE_TASK_STACK_SIZE)
...
void app_main(void)
{
    ...
    /*
     * Setup and register the UART driver
     */

    uart_config_t uart_config = {
	    .baud_rate	= ECHO_UART_BAUD_RATE,
	    .data_bits	= UART_DATA_8_BITS,
	    .parity 	= UART_PARITY_DISABLE, // no parity bits
